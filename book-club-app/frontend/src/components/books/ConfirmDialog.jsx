  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#082d24]/45 px-4 py-6">
      <div className="w-full max-w-md rounded-3xl border border-[#d9e2d8] bg-white p-6 shadow-stitch">
        <h2 className="text-2xl font-extrabold text-[#033b2a]">Bạn có chắc muốn xóa cuốn sách này không?</h2>
        <p className="mt-3 text-sm leading-6 text-[#64736d]">Hành động này không thể hoàn tác.</p>
